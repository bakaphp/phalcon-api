...
class GewearCanvasInit extends AbstractMigration
{
    public function up()
    {
        ...
        $table->addColumn('id', 'integer', ['null' => false, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'identity' => 'enable'])
            ...
            ->addColumn('use_payments', 'integer', ['null' => true, 'limit' => MysqlAdapter::INT_REGULAR, 'precision' => 10, 'after' => 'description'])
            ->addColumn('created_at', 'datetime', ['null' => true, 'after' => 'use_payments'])
